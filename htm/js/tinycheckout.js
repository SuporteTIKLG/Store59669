  ...
  function checkForm(){
    ...
    function getErrDivs(){
      if(!document.getElementById("idCompanyNameFC")){
        ...
        aErrContact=document.querySelectorAll('#newContactPJDataDIV .EstErrField:not([style*="none"])');
        aErrAddress=document.querySelectorAll('#newAddressPJDataDIV .EstErrField:not([style*="none"])');
      }
    ...
    setInterval(function(){
      if(!F$.bValidForm){
        ...
        if(!document.getElementById("idCompanyNameFC")){
          ...
          if(aErrContact.length>0)enableEditing('newContactPJDataDIVSub1','newContactPJDataDIVSub2','contact');
          if(aErrAddress.length>0)enableEditing('newAddressPJDataDIVSub1','newAddressPJDataDIVSub2','address');
        }
